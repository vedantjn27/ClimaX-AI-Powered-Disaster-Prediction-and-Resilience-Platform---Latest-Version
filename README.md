<p align="center">
  <img src="./assets/banner.svg" width="900" alt="ClimaX — Earth, Storm, Satellite, Flood animation"/>
</p>

<p align="center">
  <img src="./assets/title_banner.svg" width="900" alt="ClimaX title"/>
</p>

<p align="center">
  <img src="frontend/public/climax-logo.png" alt="ClimaX Logo" width="120" style="border-radius:20px;"/>
</p>
...
<p align="center">
<strong>Prototype tested across Delhi, Assam & Gujarat &nbsp;·&nbsp; 20+ live API endpoints &nbsp;·&nbsp; Multilingual &nbsp;·&nbsp; Production-Ready Architecture</strong>
</p>
...
<p align="center">
  ...
  <a href="#-key-features--innovation">Features</a> ·
  <a href="#-technology-stack">Tech Stack</a> ·
  <a href="#-system-workflow">Architecture</a> ·
...
| Failure | Impact |
|---------|--------|
| 🔴 Fragmented data pipelines | Satellite feeds, IoT sensors, weather APIs, and citizen reports exist in silos |
| 🔴 Reactive instead of predictive | Systems alert *after* thresholds are breached; no proactive compound risk modeling |
| 🔴 No tamper-proof accountability | Mutable records susceptible to manipulation or loss |
| 🔴 Language exclusion | Millions in disaster-prone regions cannot access alerts in their native language |
| 🔴 Resource misallocation | Manual allocation leads to critical shortfalls in high-risk zones |
| 🔴 Policy-citizen disconnect | Citizen feedback rarely influences policy revision in any structured way |
| 🔴 No resilience benchmarking | No standardized, data-driven tool to evaluate disaster readiness |
...
A multi-dimensional readiness scoring engine evaluating disaster preparedness at any administrative level — **Country, State, District, City, Locality, or Ward**.
...
All AI-generated alerts include transparent reasoning chains — not just *what* the risk is, but *why* the model flagged it, *which data sources* triggered the alert, and *what confidence level* applies. Emergency managers can trust, verify, and act on AI outputs without treating them as black boxes.
...
Outputs include allocation maps, efficiency scores, and quantum runtime metrics.
...
- **Text-to-Speech (TTS)** audio output in the user's language
...
3. AI generates evidence-based policy recommendations per disaster type and region
4. Policy drafts include rationale, implementation steps, and expected impact
5. Government agencies log formal policy actions to the blockchain

---

### 8. 📡 Citizen Reporting with Federated Verification
Citizens can submit disaster reports with GPS-tagged location, disaster type, 1–10 severity rating, descriptive text, and image URL. Reports are cryptographically verified using citizen-registered public keys, preventing false reporting at scale.

---

### 9. 📊 Regional Analysis & Trend Intelligence
Dynamic regional dashboards display climate metrics over time, disaster pattern trends, custom strategy generation per region's risk profile, and full-region analysis reports combining weather, AI, and historical data.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Multilingual input ──► IBM Granite NLP ──► Sentiment + Intent Extraction
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Normalized stream ──► RAG Engine ──► Contextual Retrieval
                        │
                        ▼
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Demand forecasts ──► QAOA Simulator ──► Optimal Allocation Map ──► Dispatch

Phase 5: BLOCKCHAIN SECURITY & AUDIT
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
All alerts + actions ──► Hyperledger Chain ──► Immutable Audit Trail

Phase 6: CITIZEN FEEDBACK → POLICY ADAPTATION
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Response ratings ──► AI Aggregation ──► Evidence-Based Policy Drafts
...
> 📘 For full setup including Docker, cloud deployment, and API key guides — see [`SETUP_GUIDE.md`](SETUP_GUIDE.md)
...
FastAPI's async architecture with `ThreadPoolExecutor` for CPU-bound tasks enables concurrent handling of 20+ live endpoints without blocking. NumPy-powered computations keep response times under 200ms.

### 🔬 Quantum Enhancement
QAOA-inspired simulation brings quantum computing principles to emergency resource allocation, achieving near-optimal solutions for NP-hard distribution problems significantly faster than classical greedy algorithms.
...
Fully modular microservices design — each feature (blockchain, quantum optimizer, AI chat, policy engine) is independently deployable. Cloud scaling is supported without architectural changes.
...
| Validation | Status |
|-----------|--------|
| 20+ live API endpoints tested | ✅ |
| Pilot regions: Delhi (heatwave), Assam (flood), Gujarat (earthquake) | ✅ |
| Modular microservices for independent scaling | ✅ |
| Cloud scaling confirmed for AI inference (Groq) | ✅ |
| Multilingual NLP across 6 Indian languages | ✅ |
| Blockchain tamper-detection tests (`backend/test.py`) | ✅ |
| Diverse disaster types: floods, earthquakes, cyclones, droughts, heatwaves | ✅ |
...
<p align="center">
  <img src="./assets/tagline_banner.svg" width="900" alt="Predict the Storm. Build the Shelter. Save Lives."/>
</p>
